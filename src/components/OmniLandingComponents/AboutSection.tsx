            ...
            <div className="my-container">
                <div className="grid lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="text-black">
                        ...
                        {/* Title */}
                        <h2 className="text-[7vw] lg:text-[4vw] font-bold tracking-tight text-orange-500">
                            OMNI <span className="text-black">CONNECTS</span>
                        </h2>

                        {/* Subtitle */}
                        <h3 className="mt-2 text-xl sm:text-2xl font-semibold text-black">
                            Empowering the Beauty, Health & Wellness World
                        </h3>

                        {/* Paragraphs */}
                        <div className="mt-6 space-y-5 text-black/60 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed w-full max-w-xl">
                            <p>
                        ...
                        <div className="mt-10 flex gap-5 flex-wrap justify-center md:justify-start">
                            {stats.map((item, index) => (
                                <GradientCard
                                    key={index}
                                    className="rounded-3xl p-6 text-center w-50"
                                >
